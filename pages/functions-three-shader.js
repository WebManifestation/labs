...
import vertexShader from "../components/Shaders/functions-three-shader/vertex-shader.glsl";
import fragmentShader from "../components/Shaders/functions-three-shader/fragment-shader.glsl";
...
export default class functionsOneShader extends Component {
  ...
  onWindowResize() {
    if (this.threeVars) {
      const { camera, renderer, material } = this.threeVars;
