...
import vertexShader from "../components/Shaders/textures-shader/vertex-shader.glsl";
import fragmentShader from "../components/Shaders/textures-shader/fragment-shader.glsl";

export default class TexturesShader extends Component {
  constructor(props) {
    super(props);
  ...
  addShader() {
    ...
    const dogTexture = loader.load("/dog.jpg");
    ...
    const overlayTexture = loader.load("/overlay.png");
