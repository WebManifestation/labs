...
import vertexShader from "../components/Shaders/colors-shader/vertex-shader.glsl";
import fragmentShader from "../components/Shaders/colors-shader/fragment-shader.glsl";

export default class ColorsShader extends Component {
  constructor(props) {
    super(props);
